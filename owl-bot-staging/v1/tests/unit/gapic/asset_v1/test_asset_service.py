...
async def test_list_saved_queries_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_saved_queries(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_analyze_org_policies_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.analyze_org_policies(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_analyze_org_policy_governed_containers_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.analyze_org_policy_governed_containers(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_analyze_org_policy_governed_assets_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.analyze_org_policy_governed_assets(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
