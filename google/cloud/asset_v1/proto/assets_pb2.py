...
Asset = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      ancestors:
          ...
          hierarchy <https://cloud.google.com/resource-manager/docs
          /cloud-platform-resource-hierarchy>`__, represented as a list
          of relative resource names. An ancestry path starts with the
          closest ancestor in the hierarchy and ends at root. If the
          asset is a project, folder, or organization, the ancestry path
          starts from the asset itself.  For example:
          ``["projects/123456789", "folders/5432",
          "organizations/1234"]``
  """,
