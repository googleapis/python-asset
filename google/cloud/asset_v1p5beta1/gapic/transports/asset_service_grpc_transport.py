...
class AssetServiceGrpcTransport(object):
    ...
    google.cloud.asset.v1p5beta1 AssetService API.
    ...
    def list_assets(self):
        """Return the gRPC stub for :meth:`AssetServiceClient.list_assets`.
        ...
        """
        return self._stubs["asset_service_stub"].ListAssets
