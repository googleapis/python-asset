...
class AssetService(object):
    ...
    def ListAssets(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.cloud.asset.v1p5beta1.AssetService/ListAssets",
            google_dot_cloud_dot_asset__v1p5beta1_dot_proto_dot_asset__service__pb2.ListAssetsRequest.SerializeToString,
            google_dot_cloud_dot_asset__v1p5beta1_dot_proto_dot_asset__service__pb2.ListAssetsResponse.FromString,
            options,
            channel_credentials,
            call_credentials,
            compression,
